...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "nthqueen" because\n';
  ...
  $wnd.__gwt_activeModules['nthqueen'] = {
    'moduleName' : 'nthqueen',
    'bindings' : function() {
      return {};
    }
 ...
 * "/nthqueen.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['nthqueen'].superdevmode = true;

  var expectedSuffix = '/nthqueen.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + nthqueen + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:nthqueen';
  var devModeSessionKey = '__gwtDevModeSession:nthqueen';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/nthqueen/nthqueen.nocache.js';
  ...
  $wnd.__gwt_activeModules['nthqueen'].canRedirect = true;
  $wnd.__gwt_activeModules['nthqueen'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/nthqueen?user.agent=' + ua + '&_callback=' + callback;
